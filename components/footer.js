...
<footer className="bg-accent-1 border-t border-accent-2">
    <div className="pt-7 flex flex-col lg:flex-col items-start">
        <img className="footerLogo lg:ml-56" src="https://images.ctfassets.net/huogrpkfou0w/7CY7o7KCg3JTy6ZuLyj0Ij/38cd70bf0eaf35f9f7511e3f9f4ffca9/Noordhoff_logo_horizontaal-SVG_v6.svg" />
